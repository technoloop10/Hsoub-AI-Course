...
تعدد الأشكال يعني قدرة الكائنات المختلفة على الاستجابة لنفس "اسم التابع" بطرق مختلفة تناسب طبيعة كل كائن. بعبارة أخرى: "واجهة واحدة (اسم واحد) لعدة أشكال من التنفيذ".
الفكرة الأساسية:
بدلاً من إنشاء دوال بأسماء مختلفة مثل draw_circle() و draw_square()، ننشئ دالة واحدة باسم draw() في الصنف الأساسي، ويقوم كل صنف مشتق بتنفيذها بطريقته الخاصة.

لماذا نستخدم تعدد الأشكال؟
المرونة: يمكنك التعامل مع مجموعة من الكائنات المختلفة وكأنها من نوع واحد طالما أنها تملك نفس التوابع.
قابلية التوسع: يمكنك إضافة أصناف جديدة (مثلاً صنف Bird) وتزويده بتابع speak دون الحاجة لتعديل الكود الذي يستدعي الدوال.

05

ملخص أركان الـ OOP الأربعة:
التغليف (Encapsulation): حماية البيانات داخل كبسولة.
